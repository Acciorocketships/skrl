...
class MADQN(Agent):
    def __init__(self,
        ...
        """
        _cfg = copy.deepcopy(MADQN_DEFAULT_CONFIG)
    ...
    def init(self, trainer_cfg: Optional[Dict[str, Any]] = None) -> None:
        ...
        if self.memory is not None:
            ...
            self.memory.create_tensor(name="actions", size=self.action_space, dtype=torch.int64, keep_dimensions=True)
